...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		...
		if (1) // Game Preferences
			...
			dat += "<b>See Runescape Chat: </b> <a href='?_src_=prefs;task=input;preference=runescapechat'>[runescapechat ? "Enabled" : "Disabled"]</a><br>"

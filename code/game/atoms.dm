...
/atom
	...
	/// If we should block saving when doing a cross-server save
	var/dont_save = FALSE

	/// Vars unique to an atom that we want to save
	var/unique_save_vars = list()

	/// Whether to save the contents stored in an atom
	var/save_contents = TRUE

	/// Whether to save the reagents stored in an atom

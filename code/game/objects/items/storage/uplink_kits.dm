...
/obj/item/storage/box/syndie_kit/experimental_cloner
	name = "experimental cloner kit"
	desc = "Contains everything necessary to start your own clone army! Emag not included."

/obj/item/storage/box/syndie_kit/experimental_cloner/PopulateContents()
	new /obj/item/circuitboard/machine/clonepod/experimental(src)
